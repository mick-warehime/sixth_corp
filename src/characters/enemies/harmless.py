...
from characters.ability_examples import Harmless, Useless
...
class HarmlessBuilder(EnemyBuilder):
    def ai_type(self) -> AIType:
        return AIType.Random

    def initial_mods(self) -> Sequence[Mod]:
        return [GenericMod(abilities_granted=(Harmless(1), Harmless(2), Useless(1), Useless(2)))]
